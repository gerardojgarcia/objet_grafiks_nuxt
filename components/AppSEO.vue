...
<template>
  <section id="seo" class="bg-gray-200 dark:bg-gray-400 p-3 md:p-8 flex flex-col md:flex-row justify-center">
    <div
      ...
      <p class="text-lg md:w-1/2 pt-6 md:pl-8 dark:text-gray-300">
        With experts in Search Engine Optimization and Analytics, we can help
        tailor your website copy to get your business noticed online.
      </p>
    </div>
        ...
        <div class="flex flex-col md:w-1/2">
          ...
          <div class=" space-y-4 md:w-3/4 pt-6 dark:text-gray-300">
            ...
            <div class="flex">
              ...
              <p>
                We have a deep understanding of how to track and analyze website
                traffic, and use this data to improve website
            ...
            <div class="flex">
              <Icon name="ri:arrow-right-double-line" class=" mr-6" size="6em" />
              <p>
                SEO best practices make us able to optimize website content to
            ...
            <div class="flex">
              <Icon name="ri:arrow-right-double-line" class=" mr-6" size="6em" />
              <p>
                Provide detailed and actionable insights that help businesses make
                data-driven decisions to improve their online presence.
              </p>
            </div>
          </div>
        </div>
        <nuxt-img src="/SEO.webp" alt="Illustration of woman standing against graphs and search bars"
          class="w-96 md:self-end md:pr-16 pt-6" sizes="sm:95vw lg:35vw" data-aos="fade-up" data-aos-duration="2000" />
      </div>
      <div class="p-16 py-16 bg-white rounded-xl shadow-lg flex flex-col md:flex-row dark:bg-night dark:text-white"
